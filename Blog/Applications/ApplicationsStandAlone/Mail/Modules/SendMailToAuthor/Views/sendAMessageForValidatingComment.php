		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
					<b>Commentaire accepté !</b>
				</td>
			</tr>
			<tr>
				<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
					Votre commentaire a été accepté. Pour terminer la publication de votre commentaire, cliquez sur le lien ci-dessous :
				</td>
			</tr>
			<tr>
				<td style="text-align: center;">
					<a href="<?php echo $lienValidation; ?>" class="btn-class">Publier mon commentaire</a>
				</td>
			</tr>
		</table>
	</td>
