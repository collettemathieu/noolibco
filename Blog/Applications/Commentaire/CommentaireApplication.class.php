...
// +----------------------------------------------------------------------+
// | Classe PHP de l'application commentaire.                             |
// +----------------------------------------------------------------------+
// | Auteur : Mathieu COLLETTE <collettemathieu@scienceapart.com>         |
// +----------------------------------------------------------------------+

/**
 * @name:  Classe CommentaireApplication
 * @access: public
 * @version: 1
 */ 

namespace Applications\Commentaire;

class CommentaireApplication extends \Library\Application
{
  /* Appel du constructeur parent */
  public function __construct()
  {
    parent::__construct();
    $this->nomApplication = 'Commentaire';
  }
  
  /* Permet de démarrer l'application Commentaire */
  public function run()
  {
