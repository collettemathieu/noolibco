			...
			<div class="row">
					...
					<ul class="list-group listeCommentaires listeCommentairesEnAttente">
						...
						if(isset($commentaires)){
							foreach($commentaires as $commentaire){
								if(!$commentaire->getEnAttenteValidationAuteurCommentaire() && $commentaire->getCours() instanceof \Library\Entities\Cours){
								?>
							<li class="list-group-item commentaire" enLigneComment="<?php echo (int) $commentaire->getEnLigneCommentaire();?>" titreCours = "<?php echo $commentaire->getCours()->getTitreCours();?>" texteComment = "<?php echo $commentaire->getTexteCommentaire();?>" auteurComment = "<?php echo $commentaire->getUtilisateur()->getNomUtilisateur();?>" idComment = "<?php echo $commentaire->getIdCommentaire();?>"><?php echo $commentaire->getCours()->getTitreCours().' | de '.$commentaire->getUtilisateur()->getNomUtilisateur().' | '.substr($commentaire->getTexteCommentaire(), 0, 20);?></li>
						<?php }}} ?>
					</ul>
				...
				<div class="col-lg-8 sousMenu centering">
					...
					<ul class="list-group listeCommentaires listeCommentairesEnAttenteValidationAuteur">
						...
						if(isset($commentaires)){
							foreach($commentaires as $commentaire){
								if(!$commentaire->getEnLigneCommentaire() && $commentaire->getEnAttenteValidationAuteurCommentaire() && $commentaire->getCours() instanceof \Library\Entities\Cours){
								?>
						<li class="list-group-item commentaire" enLigneComment="<?php echo (int) $commentaire->getEnLigneCommentaire();?>" titreCours = "<?php echo $commentaire->getCours()->getTitreCours();?>" texteComment = "<?php echo $commentaire->getTexteCommentaire();?>" auteurComment = "<?php echo $commentaire->getUtilisateur()->getNomUtilisateur();?>" idComment = "<?php echo $commentaire->getIdCommentaire();?>"><?php echo $commentaire->getCours()->getTitreCours().' | de '.$commentaire->getUtilisateur()->getNomUtilisateur().' | '.substr($commentaire->getTexteCommentaire(), 0, 20);?></li>
						<?php }}} ?>
					</ul>
				...
				<div class="col-lg-8 sousMenu centering">
					...
					<ul class="list-group listeCommentaires listeCommentairesEnLigne">
						...
						if(isset($commentaires)){
							foreach($commentaires as $commentaire){
								if($commentaire->getEnLigneCommentaire() && $commentaire->getCours() instanceof \Library\Entities\Cours){
								?>
						<li class="list-group-item commentaire" enLigneComment="<?php echo (int) $commentaire->getEnLigneCommentaire();?>" titreCours = "<?php echo $commentaire->getCours()->getTitreCours();?>" texteComment = "<?php echo $commentaire->getTexteCommentaire();?>" auteurComment = "<?php echo $commentaire->getUtilisateur()->getNomUtilisateur();?>" idComment = "<?php echo $commentaire->getIdCommentaire();?>"><?php echo $commentaire->getCours()->getTitreCours().' | de '.$commentaire->getUtilisateur()->getNomUtilisateur().' | '.substr($commentaire->getTexteCommentaire(), 0, 20);?></li>
						<?php }}} ?>
					</ul>
