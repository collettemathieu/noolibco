	...
	<div class="row-fluid">
		<div class="col-lg-12 centering maxWidth">
			<div class="col-lg-1 sousMenu">
				<form class="" method="post" action="/ForAdminOnly/Articles/PublierDepublierArticle">
					<button type="submit" class="infoBulle menuArticleBackend btn btn-margin btn-lg <?php if($article->getEnLigneArticle()){echo 'btn-danger';}else{echo 'btn-success';}?>" title="<?php if($article->getEnLigneArticle()){echo 'Retirer cet article';}else{echo 'Publier cet article';}?>"><i class="glyphicon <?php if($article->getEnLigneArticle()){echo 'glyphicon-remove';}else{echo 'glyphicon-ok';}?>"></i></button>
					<input type="hidden" name="idArticle" value="<?php echo $article->getIdArticle();?>"/>
				</form>
				<button type="button" class="infoBulle menuArticleBackend btn btn-info btn-margin btn-lg" data-toggle="modal" href="#editerCategorie" title="Editer la catégorie de l'article"><i class="glyphicon glyphicon-list-alt"></i></button>
				<button type="button" class="infoBulle menuArticleBackend btn btn-warning btn-margin btn-lg" data-toggle="modal" href="#editerDescription" title="Editer la description de l'article"><i class="glyphicon glyphicon-align-left"></i></button>
				<button type="button" class="infoBulle menuArticleBackend btn btn-default btn-margin btn-lg" data-toggle="modal" href="#editerMotCles" title="Editer les mots-clés de l'article"><i class="glyphicon glyphicon-tags"></i></button>
				<a class="infoBulle menuArticleBackend btn btn-default btn-margin btn-lg" href="/ForAdminOnly/Articles/PostOnSocialNetworks/idArticle=<?php echo $article->getIdArticle();?>" title="Poster sur Facebook et Twitter"><i class="glyphicon glyphicon-thumbs-up"></i></a>	
				<button type="button" class="infoBulle menuArticleBackend btn btn-danger btn-margin btn-lg" data-toggle="modal" href="#supprimerArticle" title="Supprimer l'article"><i class="glyphicon glyphicon-trash"></i></button>	
			</div>
			<div class="col-lg-offset-1 col-lg-10 sousMenu">
				<div class="row">
					<a class="col-lg-4" data-toggle="modal" href="#modifierImageArticle">
						<img class="infoBulle" data-toggle="tooltip" title="Editer l'image de présentation de l'article" src="data:image/png;charset=utf8;base64,<?php echo base64_encode(file_get_contents($article->getUrlImageMiniatureArticle())); ?>"/>
					</a>
					<a class="col-lg-8" data-toggle="modal" href="#editerTitre">
						<h2 class="infoBulle" data-toggle="tooltip" title="Editer le titre de l'article"><?php echo $article->getTitreArticle();?></h2>
					</a>
					<h3 class="col-lg-8 cesure"><?php echo $article->getDescriptionArticle();?></h3>
				</div>
			</div>
			<div class="col-lg-offset-2 col-lg-10 sousMenu">
				<form action="/ForAdminOnly/Articles/ModifierTexteArticle" method="post" class="well well-lg">
					<legend>Texte de l'article</legend>
					<div class="form-group">
						<textarea rows="30" name="nouveauTexte" id="nouveauTexte" class="form-control"><?php echo $article->getTexteArticle();?></textarea>
					</div>
					<input type="hidden" name="idArticle" id="idArticle" value="<?php echo $article->getIdArticle();?>"/>
					<button class="btn btn-primary" type="submit">Modifier</button>	
				</form>
			</div>
			<div class="col-lg-offset-2 col-lg-10 sousMenu">
				<form action="/ForAdminOnly/Articles/ModifierReferencesArticle" method="post" class="well well-lg">
					<legend>Références de l'article</legend>
					<div class="form-group">
						<textarea rows="10" id="referencesArticle" name="nouvellesReferences" class="form-control"><?php echo $article->getReferencesArticle();?></textarea>							
					</div>
					<input type="hidden" name="idArticle" value="<?php echo $article->getIdArticle();?>"/>
					<button type="button" class="infoBulleBottom pull-right menuArticleBackend btn btn-info btn-margin btn-lg" data-toggle="modal" href="#addReference" title="Ajouter une référence"><i class="glyphicon glyphicon-plus"></i></button>	
...
<div id="editerTitre" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">x</button>
			<h2 class="modal-title">Titre de l'article</h2>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="col-lg-10 centering">
						<form action="/ForAdminOnly/Articles/ModifierTitreArticle" method="post" class="well well-lg">
							<legend>Modifier le titre de l'article ?</legend>
							<div class="form-group">
								<label>Titre actuel</label>
								<input type="text" name="nouveauTitre" maxlength="50" class="form-control" value="<?php echo $article->getTitreArticle();?>"/>
							</div>
							<input type="hidden" name="idArticle" value="<?php echo $article->getIdArticle();?>"/>
							<button class="btn btn-primary" type="submit">Modifier</button>	
						</form>
...
<div id="editerCategorie" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">x</button>
			<h2 class="modal-title">Catégorie de l'article</h2>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="col-lg-10 centering">
						<form action="/ForAdminOnly/Articles/ModifierCategorieArticle" method="post" class="well well-lg">
							<legend>Modifier la catégorie de l'article ?</legend>
							<div class="form-group">
								<label>Catégorie actuelle</label>
								<select name="nouvelleCategorieArticle" class="form-control input-sm">
...
<div id="modifierImageArticle" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">x</button>
			<h2 class="modal-title">Image de présentation de l'article</h2>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="col-lg-10 centering">
						<div class="file-picker" id="dropzoneImageArticle">
...
<div id="editerDescription" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">x</button>
			<h2 class="modal-title">Description de l'article</h2>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="col-lg-10 centering">
						<form action="/ForAdminOnly/Articles/ModifierDescriptionArticle" method="post" class="well well-lg">
							<legend>Modifier la description de l'article ?</legend>
							<div class="form-group">
								<label>Description actuelle</label>
								<textarea rows="5" name="nouvelleDescription" class="form-control"><?php echo $article->getDescriptionArticle();?></textarea>							</div>
							<input type="hidden" name="idArticle" value="<?php echo $article->getIdArticle();?>"/>
							<button class="btn btn-primary" type="submit">Modifier</button>	
						</form>
					</div>
...
<div id="editerMotCles" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">x</button>
			<h2 class="modal-title">Mots-clés de l'article</h2>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="col-lg-10 centering">
						<form action="/ForAdminOnly/Articles/ModifierMotClesArticle" method="post" class="well well-lg">
							<legend>Modifier les mots-clés de l'article ?</legend>
							<div class="form-group">
...
<div id="supprimerArticle" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">x</button>
			<h2 class="modal-title">Suppression de l'article</h2>
		</div>
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="col-lg-10 centering">
						<form action="/ForAdminOnly/Articles/SupprimerArticle" method="post" class="well well-lg">
							<legend>Etes-vous sûr de vouloir supprimer cet article ?</legend>
							<input type="hidden" name="idArticle" value="<?php echo $article->getIdArticle();?>"/>
