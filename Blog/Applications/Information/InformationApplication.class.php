...
// +----------------------------------------------------------------------+
// | Classe PHP de l'application InformationApplication.				  |
// +----------------------------------------------------------------------+
// | Auteur : Mathieu COLLETTE <collettemathieu@aboutscience.net>		  |
// +----------------------------------------------------------------------+

/**
 * @name:  Classe InformationApplication
 * @access: public
 * @version: 1
 */

namespace Applications\Information;

class InformationApplication extends \Library\Application
{
	...
	{
		parent::__construct();
		$this->nomApplication = 'Information';
	}
