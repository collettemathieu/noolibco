...
// +----------------------------------------------------------------------+
// | Classe PHP de l'application HandleDataByAjax.      	         	  |
// +----------------------------------------------------------------------+
// | Auteur : Mathieu COLLETTE <collettemathieu@noolib.com>               |
// +----------------------------------------------------------------------+

/**
 * @name:  Classe HandleDataByAjax
 * @access: public
 * @version: 1
 */ 

namespace Applications\HandleData;

class HandleDataApplication extends \Library\Application
{
	...
	{
		parent::__construct();
		$this->nomApplication = 'HandleData';
	}

	/**
	* Permet de démarrer l'application HandleData
	*/
	public function run()
	{
