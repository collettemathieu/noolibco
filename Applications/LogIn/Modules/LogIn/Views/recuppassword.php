		...
		<div class="row">
			<div class="col-lg-12 fadeIn">
				<div class="col-lg-6">
					...
					<h2>Please enter your email and we will send you a link to reset your password.</h2>
				</div>
				...
				<form class="well well-lg col-lg-5" method="post" action="/LogIn/RecupPassword/Request">
					...
					<button class="btn btn-primary" type="submit">Ask for a new password</button>
				</form>
			</div>
		</div>
	</div>
