...
// +----------------------------------------------------------------------+
// | Classe PHP de l'application NooSpaceApplication.                     |
// +----------------------------------------------------------------------+
// | Auteur : Mathieu COLLETTE <collettemathieu@noolib.com>               |
// +----------------------------------------------------------------------+

/**
 * @name:  Classe NooSpaceApplication
 * @access: public
 * @version: 1
 */ 

namespace Applications\NooSpace;

class NooSpaceApplication extends \Library\Application
{
	...
	{
		parent::__construct();
		$this->nomApplication = 'NooSpace';
	}

	/**
	* Permet de démarrer l'application NooSpaceApplication
	*/
	public function run()
	{
