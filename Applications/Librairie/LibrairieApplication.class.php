...
// +----------------------------------------------------------------------+
// | Classe PHP de l'application Librairie.								  |
// +----------------------------------------------------------------------+
// | Auteur : Mathieu COLLETTE <collettemathieu@noolib.com>    			  |
// +----------------------------------------------------------------------+

/**
 * @name:  Classe LibrairieApplication
 * @access: public
 * @version: 1
 */

namespace Applications\Librairie;

class LibrairieApplication extends \Library\Application
{
	...
	{
		parent::__construct();
		$this->nomApplication = 'Librairie';
	}

	/**
	* Permet de démarrer l'application Librairie
	*/
	public function run()
	{
