...
// +----------------------------------------------------------------------+
// | Classe PHP de l'application SubmitAnApplication. 	                  |
// +----------------------------------------------------------------------+
// | Auteur : Mathieu COLLETTE <collettemathieu@noolib.com>               |
// +----------------------------------------------------------------------+

/**
 * @name:  Classe SubmitAnApplication
 * @access: public
 * @version: 1
 */ 

namespace Applications\SubmitAnApplication;

class SubmitAnApplicationApplication extends \Library\Application
{
	...
	{
		parent::__construct();
		$this->nomApplication = 'SubmitAnApplication';
	}

	/**
	* Permet de démarrer l'application SubmitAnApplication
	*/
	public function run()
	{
