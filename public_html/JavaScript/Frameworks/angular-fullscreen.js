(function(window) {
   var createModule = function(angular) {
      var module = angular.module('FullScreenAngular', []);
               ...
               if ($attrs.fullscreen) {
                  $scope.$watch($attrs.fullscreen, function(value) {
                     ...
                     if (value && !isEnabled) {
                        ...
                        //$element.attr('data-original-title','Normal screen mode');
                     } else if (!value && isEnabled) {
                        Fullscreen.cancel();
                        $element.removeClass('isInFullScreen');
                        //$element.btn.attr('data-original-title','Full screen mode');
                     }
                  });
   ...
   if (typeof define === "function" && define.amd) {
      define("FullScreenAngular", ['angular'], function (angular) { return createModule(angular); } );
