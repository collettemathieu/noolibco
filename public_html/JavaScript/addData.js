function addData(){
  ...
  $('#fileLocalData').change(function(){
    if(this.files.length == 1){ // On ne tolère qu'un seul fichier à charger
      ...
      if((allowedImgType.indexOf(extFichier) != -1 || allowedDicomType.indexOf(extFichier) != -1) && this.files[0].size > 6000000){
        uploadAllowed = false;
      }
      ...
      try{
        ...
        if(typeof namespaceGraphLocalData.dataForForm != "undefined"){
            ...
            var data = [],
              ...
              sizeAllowed = 300000,
              isTableSelected = overlayFormulaire.find('.modal-body .tableResult').hasClass('active');
