		    ...
		    <div class="modal-content">
				...
				<div class="modal-body">
					<ul class="list-unstyled">
						...
						<li><h3>Founder & author</h3><ul class="list-unstyled"><li class="teamPicture"><a href="/Profile/idAuteur=58"><span class="founder"></span><p class="text-center">Mathieu Collette</p></a></li></ul></li>
						<li><h3>Settings</h3>
							<ul class="list-unstyled">
