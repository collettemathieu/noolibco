 ...
 *
 */
namespace Library\Facebook\GraphNodes;

use Library\Facebook\GraphNodes\GraphNode;
...
class GraphNodeFactory
{
    ...
    public function safelyMakeGraphNode(array $data, $subclassName = null)
    {
        ...
        return new GraphNode($items); //  Attention avant c'était return new $subclassName($items);
    }
